...
parser.add_argument('--h2', default=None, type=str, nargs='*',
...
parser.add_argument('--baseline-ld', default=None, type=str,
    help='Additional ld files to append to --ref-ld')
parser.add_argument('--baseline-ld-chr', default=None, type=str,
    help='Additional ld-chr files to append to --ref-ld-chr')
